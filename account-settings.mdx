...
Es la configuración global de toda tu instancia de Agentes Virtuales ETB. Te permite modificar información general de tu empresa.
...
- Puedes activar o desactivar la opción **Auto-resolve conversations:** esta es una función que **cierra automáticamente** (marca como “Resuelta”) cualquier conversación que lleve cierto tiempo **sin actividad, que puede suceder en escenarios como:**
  ...
  - Si pasa la cantidad de minutos/horas/días que tú configures, Agentes Virtuales ETB resuelve la conversación solo marcándola como Resuelta
