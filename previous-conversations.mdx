...
Si el contacto es nuevo, lo que quiere decir que aún no ha tenido ninguna conversación antes, la lista estará vacía y verás el mensaje: “No hay conversaciones previas asociadas a este contacto”. Esto también puede suceder si **el contacto tuvo conversaciones, pero con otro identificador,** es decir si antes escribió desde otro canal, Agentes Virtuales ETB lo trata como otro contacto distinto, por lo que no aparecerá aquí, a menos que los fusiones.
