...
2. El filtro que elijas en la parte superior de este segundo panel. Aquí tienes 3 opciones:
   - **Mías:** Agentes Virtuales ETB permite asignar conversaciones para que sean atendidas exclusivamente por un agente. Así entonces, si eres un agente, al iniciar sesión, si seleccionas este encabezado, verás la lista de las conversaciones que han sido asignadas para ser atendidas por ti.
...
El primero de ellos es la opción para Filtrar conversaciones, es la opción que te da Agentes Virtuales ETB para crear tus propios filtros, de acuerdo a las necesidades de tu negocio. Te explicaremos paso a paso como aprovechar esta funcionalidad:
...
si das click sobre la flecha hacia abajo, se desplegará una lista con varias opciones generales asignadas por el sistema, que corresponden a funcionalidades que existen en Agentes Virtuales ETB y que abarcan muchas de las descripciones principales que pueden tener tus conversaciones como:
...
Agentes Virtuales ETB te ofrece varias opciones para que puedas elegir de acuerdo a lo que más te beneficie.
