...
- Si pasas el mouse sobre el primer ícono, verás hace cuanto tiempo fue creado este contacto en Agentes Virtuales ETB

![Icono de fecha de creación](./images/conversations/creation-date-icon.png)

- Si das click sobre el segundo ícono, se abrirá una nueva ventana que te ubicará en la sección de contactos de Agentes Virtuales ETB. Allí, podrás editar la información del usuario con el que estás conversando.
...
En el campo **Contacto para combinar**, en la lista desplegable sólo aparecerán los contactos que por datos comunes, Agentes Virtuales ETB detecta que están duplicados, del usuario con el que estás conversando. En caso de que este usuario no tenga otro perfil, no se desplegarán opciones en la lista.
