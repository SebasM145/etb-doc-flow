...
Si quieres añadir un nuevo miembro a tu equipo de trabajo en la plataforma Flow, solo debes:
...
Una vez lo cree, el nuevo agente será redireccionado a la plataforma Flow, y en tu sección de - Ajustes, - Agentes, ya verás que donde antes decía "Verificación pendiente", ahora dirá **"Verificado"**
