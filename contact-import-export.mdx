...
Si lo que deseas es subir a tu plataforma de Agentes Virtuales ETB toda una base de datos de contactos con la que ya cuentas, solo debes dar click en la opción de Importar contactos, y a continuación verás el siguiente mensaje
