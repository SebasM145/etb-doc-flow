...
Debajo del título **Canales**, verás una lista con los medios de comunicación que tienes enlazados a tu APP de Flow: Instagram, whatsapp, messenger, etc. Así entonces, a través de este filtro, verás discriminadas las conversaciones dependiendo del canal desde donde el cliente te está escribiendo.
...
Al igual que con la opción anterior, este submenú solo lo verás si en tu plataforma existen **Equipos** (para conocer más sobre esta opción que te ofrece Flow, puedes dirigirte en este manual a la sección de "Ajustes", y elegir "Equipos"). Si aún no tienes ningún equipo creado, este submenú no estará disponible en este primer panel de Conversaciones, pero si sí existen, verás una lista de todos lo equipos, y al seleccionar uno, en el segundo panel estarán visibles las conversaciones que han sido asignadas al equipo elegido.
