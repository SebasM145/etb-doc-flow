...
En **Agentes Virtuales ETB**, aunque **automatizaciones** y **macros** a veces parecen similares, cumplen **propósitos distintos** y se usan en **momentos diferentes**.

Las automatizaciones son **reglas automáticas** que se ejecutan **sin intervención humana** cuando ocurre algo específico. Esto quiere decir que Agentes Virtuales ETB _“actúa solo”_ según las condiciones que tú defines, como por ejemplo:
